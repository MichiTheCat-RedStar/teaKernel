...
print_colored_string(const char* str, uint8_t color); - вывод цветной строки, надстройка над print_string() и set_color(), не меняет цвет курсора
...
char* input(); - ввод с клавиатуры, читающий до 255 символов
